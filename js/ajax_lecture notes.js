...
// $.ajax("https://hookb.in/qBpLezG0y9CEwPllwP0W").done(function(data){
//     console.log(data);
// })
...
// $.ajax("https://hookb.in/qBpLezG0y9CEwPllwP0W", //URL is still the first argument
//     {
//         type: "POST",
//         data: {
//             firstName: 'Kapena',
...
//
//     var randomFact = $.ajax("https://www.themealdb.com/").done(function(data){
...
// Different MilliSeconds = different response times BACK from our API
...
// $.post("https://hookb.in/BYlyBrYQxackN6yyN67p", //URL is still the first argument
//     {
//         firstName: 'Kapena',
//         lastName: 'Magallan',
//         POB: 'California'
