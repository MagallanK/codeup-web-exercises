...
//Past modules: Maybe use the var into an alert to show that we've captured the value.
...
// while(!haveToy){
//     haveToy = confirm("Please can I have the toy?");
// }
//
// if(haveToy){
...
// If we give the Codie the toy from the get go, we won't see the behavior in the loop at all.

// TODO: Quasar~ create a WHILE loop that runs as long as i is less than 10;
// as long as the var i is less than 10. console.log information about what's going on?
...
// }
// console.log("~~~~~~~~~~~~~~~~~");
// //While loop down to 10
// var j = 10;
// while (j >= 0){
//     console.log("Hey there! J is currently : " + j);
//     j--;
// }
