 ...
 */
    ...
    alert("Your bill total was $" + totalBill);
    var tipPercent = prompt("What percentage would you like to tip for $" + totalBill);
    confirm("This will be your tip " + tipPercent + "%. Is this correct?");
    var finalBill = totalBill * (tipPercent / 100);
    alert("Total amount to tip for bill is $" + finalBill);
